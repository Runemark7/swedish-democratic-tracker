// Shared mock data for the Swedish Democratic Tracker
// All copy is in Swedish. Data is illustrative — to be replaced with real sources.

const SDT_DATA = {
  // Parliament (Riksdagen) — national level
  riksdag: {
    title: "Riksdagen",
  ...
  // Regional level — example: Region Stockholm
  region: {
