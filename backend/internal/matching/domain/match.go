...
//
// RelevantVotes counts vote points matched to the goal. It is a fact about our
// matching, not a judgement about the party.
//
// The alignment percentage was retired in migration 000034: it systematically
// disadvantaged opposition parties, because a party voting Nej to the rejection
// of its own motion was scored as breaking its own promise.
